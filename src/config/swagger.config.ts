    ...
    schemas: {
      ...
      ProductSchema: {
        ...
        properties: {
          ...
          brandColor: { type: "string", example: "#159C82", description: "Product accent colour used in the stack builder and card (hex)" },
          bgColor:    { type: "string", example: "linear-gradient(178deg, #FBF8EE 0%, #E6F7F3 42%, #C4EEE4 100%)", description: "Background gradient or colour used on product details hero section" },
          // Inventory
